          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            ...
            <div>
              <blockquote className="text-xl font-medium leading-8 text-base-content sm:text-2xl sm:leading-10">
                Flashbar has completely transformed how we engage with our website visitors. The popup notifications are so easy to set up and have increased our conversion rates by 40%. The customization options are incredible - we can match our brand perfectly while grabbing attention at the right moments.
              </blockquote>
